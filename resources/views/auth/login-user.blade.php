                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="javascript:void(0);" class="brand-logo">                              
                                <h2 class="brand-text text-primary ml-1">User Sign In</h2>                                                                     
                            </a>
                            <h4 class="card-title mb-1">Welcome User! 👋</h4>
                            <p class="card-text mb-2">Please sign-in to your account</p>

                            <form class="login-form mt-2" id="login-form" action="{{ route('post.login') }}" method="POST">
                                @csrf
