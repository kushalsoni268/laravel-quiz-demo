                    ...
                    <li class="nav-item dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="user-nav d-sm-flex d-none">
                                <span class="user-name font-weight-bolder">{{ isset(Auth::user()->name) ? Auth::user()->name : '' }}</span>
                                <span class="user-status"></span>
                            </div>
                            <span class="avatar">                                
                                <?php $url = Helper::DefultdisplayProfilePath(); ?>
                                <img class="round" src="{{ $url }}" alt="avatar" height="40" width="40">
                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item {{ Route::is('users.*') ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('users.index') }}">
                            <i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Users</span>
                        </a>
                    </li>
                    @endIf
                    
                    @if(Auth::user()->role_id==config('const.roleAdmin'))
                    <li class="nav-item {{ Route::is('question-answer.*') ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('question-answer.index') }}">
                            <i data-feather="grid"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Question & Answer</span>
                        </a>
                    </li>
                    @endIf

                    @if(Auth::user()->role_id==config('const.roleUser'))
                    <li class="nav-item {{ Route::is('test')  ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('test') }}">
                            <i data-feather="grid"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Test</span>
                        </a>
                    </li>
                    @endIf
                </ul>
